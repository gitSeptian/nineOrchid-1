<%@ Page Title="" Language="C#" MasterPageFile="~/NineOrchid.Master" AutoEventWireup="true" CodeBehind="CheckoutKamar.aspx.cs" Inherits="NineOrchid.Pages.Project.CheckoutKamar" %>
    ...
    <form role="form" runat="server" class="Content-custom-wrapper">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><strong>Checkout Kamar Kos</strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="Gedung Kos">Kamar Kos </label>
                ...
                <div class="form-group">
                    <label for="KategoriKamar">Tanggal Checkout </label>
        ...
        <div class="box box-primary" style="margin-right: 1px !important">
            <div class="box-header with-border">
                <h3 class="box-title"><strong>Tabel Checkout Kamar</strong></h3>
            </div>
            <%--<div class="box-body">
